                ...
                <form action="{{route('index_sonuc')}}" method="post" class="form-group">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-4"><label>Konu</label>
                                <input class="form-control" type="text" name="title">
                            </div>
                            <div class="col-md-4"><label>Değişiklik</label><br>
                                <textarea class="form-control" name="desc" id="" cols="30" rows="2"></textarea>
                            </div>
                            <div class="col-md-4"><label>Tarih</label><br>
                                <input type="datetime-local" class="form-control" name="date">
                            </div>
                            <div class="col-md-2"><label>Başlangıç Saati</label><br>
                                <input type="time" class="form-control" name="start_time">
                            </div>
                            <div class="col-md-2"><label>Bitiş Saati</label><br>
                                <input type="time" class="form-control" name="end_time">
                            </div>
                            <div class="col-md-4"><label>Kesinti Süresi</label>
                                <input class="form-control" type="text" name="downtime">
                            </div>
